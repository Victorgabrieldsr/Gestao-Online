...
$_SESSION['tituloNav'] = "Dashboard";
// Carrega os anos disponíveis
$categoria = 'Fundo Imobiliario';
$query = "SELECT DISTINCT YEAR(dataCompra) AS ano FROM ativos WHERE  idUser = ? ORDER BY ano DESC;";
    ...
    <script>
        ...
        function carregarGraficos() {
            ...
            .then(data => {
                ...
                chart1 = gerarGraficoDonut(data.valoresTotaisFluxoTotalDonut, data.nomesAtivosFluxoTotalDonut, 'Fluxo Total por Ativo', 'chart1');
                chart2 = gerarGraficoArea(data.valoresTotaisFluxoTotalGrafico, data.nomesAtivosFluxoTotalGrafico, 'Fluxo Total Mensal', 'chart2');
            })
